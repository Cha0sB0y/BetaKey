...
public class MojangUUIDResolve {
    ...
    public static final LoadingCache<String, ProxyCacheResult> uuidCache = CacheBuilder
            .newBuilder()
            .expireAfterAccess(10, TimeUnit.MINUTES)
            .build(new CacheLoader<String, ProxyCacheResult>() {
                       @Override
                       public ProxyCacheResult load(String name) {
                           ...
                           try {
                               ...
                               MojangUUIDProfile p = (MojangUUIDProfile) gson.fromJson(content.toString(), MojangUUIDProfile.class);
    ...
    public static final LoadingCache<String, ProxyCacheResult> nameCache = CacheBuilder
            .newBuilder()
            .expireAfterAccess(10, TimeUnit.MINUTES)
            .build(new CacheLoader<String, ProxyCacheResult>() {
                @Override
                public ProxyCacheResult load(String uuid) {
                    ...
                    try {
                        ...
                        return new ProxyCacheResult(InfoType.NAME, array.get(array.size() - 1).getAsJsonObject().get("name").getAsString());
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    return new ProxyCacheResult();
